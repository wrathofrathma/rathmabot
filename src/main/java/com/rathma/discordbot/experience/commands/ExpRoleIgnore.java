...
public class ExpRoleIgnore extends Command {
    public ExpRoleIgnore(CommandService commandService, Message message) {
        identifier = "exp";
        childIdentifier = "roleblock";
    ...
    public MessageEmbed buildRoleList(long guildID){
        ...
        embedBuilder.setDescription("**" + guild.getName() + "'s roles ignored by exp service.**");
        String roles = "";
