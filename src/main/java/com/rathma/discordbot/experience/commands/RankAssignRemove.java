...
public class RankAssignRemove extends Command{
    public RankAssignRemove(CommandService commandService, Message message){
    ...
    public void run(Message message){
        ...
        experienceService.removeRankRoles(guildID, roleIDs);
        if(writePermissions)
            message.getChannel().sendMessage("Successfully removed roles from ranked based auto assign.").queue();
        commandService.ongoingCommands.remove(this);
    }
}
